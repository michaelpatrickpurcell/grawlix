...
This repository contains several versions of the rules needed to play Grawlix, 2D and 3D print-and-play files, and a sell sheet.
  ...
  - Print-and-Play Files
    ...
    - The file [Grawlix Stickers (Simple)](PnPFiles/2DPnP/grawlix_pnp_stickers_simple.pdf) contains images which can be printed on label paper, cut out, and affixed to one-inch square tiles to create a set of Grawlix tiles.
  ...
  - Sell Sheet
     - The [sell sheet](grawlix_sell_sheet.pdf) is a one-page pdf document that contains a high-level overview of the game. This document is primarily intended for prospective publishers rather than players.
