...
\node () at (1.25,1.25) {{\setmainfont[Scale=2.175]{Cooper Black} Grawlix}};
\node () at (1.25,0.65) {{\setmainfont[Scale=0.825]{Quicksand-Medium} The Typesetters' Game}};
