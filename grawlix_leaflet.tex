...
\begin{center}
\setmainfont{Quicksand-Medium}
\Huge A Tale of Two Typesetters
\end{center}
...
\node[tile, rotate=15] () at (1.25,-3.375) {};
\pic[rotate=15] () at (1.25, -3.375) {dollar={violet}};

\node[tile, rotate=-30] () at (2.25,-3.375) {};
\pic[rotate=-30] () at (2.25, -3.375) {dollar={blue}};

\node[tile, rotate=30] () at (0.25,-3.375) {};
\pic[rotate=30] () at (0.25, -3.375) {asterisk={violet}};
\end{tikzpicture}
...
The six glyphs are: \smallat, \smallpound, \smalldollar, \smallpercent, \smallampersand, \smallasterisk. The six colors are: red, orange, yellow, green, blue, purple.
...
%  \item[Colors:] orange, green, blue, or purple.
%\end{description}
...
Consider the location labelled with the question mark. There are no tiles in this row. The tiles in this column are the blue \smallat, orange \smallasterisk, and green \smalldollar. So, the allowed glyphs are: \smallpound, \smallpercent, \smallampersand. The allowed colors are: red, yellow, purple.
